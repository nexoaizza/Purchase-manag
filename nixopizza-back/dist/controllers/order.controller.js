...
exports.deleteOrder = exports.getOrderAnalytics = exports.getOrder = exports.getOrderStats = exports.getOrdersByFilter = exports.updateOrder = exports.verifyOrder = exports.submitOrderForReview = exports.assignOrder = exports.createOrder = void 0;
...
const deleteOrder = async (req, res) => {
    try {
        const orderId = req.params.orderId;
        const order = await order_model_1.default.deleteOne({ _id: orderId });
        if (!order) {
            res.status(404).json({ message: "Order not found" });
            return;
        }
