...
exports.getTransfersByStock = exports.deleteTransfer = exports.updateTransfer = exports.getTransferById = exports.getAllTransfers = exports.createTransfer = void 0;
...
const getAllTransfers = async (req, res) => {
    try {
        const { status, takenFrom, takenTo, productName, dateFrom, dateTo, sortBy = "newest", page = 1, limit = 10, } = req.query;
