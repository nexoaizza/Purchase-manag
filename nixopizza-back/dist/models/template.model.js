...
const templateItemSchema = new mongoose_1.Schema({
    productId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Product", required: true },
    quantity: { type: Number, required: true, min: 0 },
}, { _id: false });
const purchaseTemplateSchema = new mongoose_1.Schema({
...
const PurchaseTemplate = mongoose_1.default.model("PurchaseTemplate", purchaseTemplateSchema);
exports.default = PurchaseTemplate;
